...
4. Alternative approach: Union-Find, unioning every land cell with its land neighbors, then counting the number of distinct roots. Useful as a follow-up if the interviewer asks for an "online" version where land can be added dynamically (see LC 305, Number of Islands II).
